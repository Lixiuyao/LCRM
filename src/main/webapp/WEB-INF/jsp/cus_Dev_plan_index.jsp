...
<script type="text/javascript">
	$(function(){
		//查询指定id的销售机会
		$.post("${ctx}/saleChance/selectById.action", 
		...
		/*展示数据的datagrid表格*/
		$("#datagrid").edatagrid({
			url:'${ctx}/cusDevPlan/selectAll.action?saleChanceId=${param.saleChanceId}',//只查询已分配咨询师的
			...
			destroyUrl:'${ctx}/cusDevPlan/delete.action',
			title:'开发计划项',
			singleSelect:true,
			toolbar:'#toolbar',
			rownumbers:true,
