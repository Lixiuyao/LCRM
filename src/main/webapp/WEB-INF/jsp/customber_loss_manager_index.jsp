...
<script type="text/javascript">
	$(function(){
		//查询指定id的销售机会
		$.post("${ctx}/customerLoss/selectById.action", 
				{id : '${param.id}'}, 
				function(result) {
		...
		/*展示数据的datagrid表格*/
		$("#datagrid").edatagrid({
			url:'${ctx}/customerLossMeasure/selectAll.action?lossId=${param.id}',//只查询已分配咨询师的
...
<body>
	...
	<div id="p" class="easyui-panel" title="销售机会信息" style="width: 700px;height: 100px" >
	 	<table cellspacing="8px">
	   		<tr>
	   			<td>客户编号：</td>
	   			<td><input type="text" id="s_id" name="id" readonly="readonly"/></td>
	   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	   			<td>客户名称</td>
