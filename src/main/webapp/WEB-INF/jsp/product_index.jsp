	...
	$(function(){
		$("#datagrid").datagrid({
			...
			columns:[[
			    ...
			    {field:"name",title:"商品名称",width:80,algin:"center"},     
			    {field:"model",title:"型号",width:80,algin:"center"},     
			    {field:"unit",title:"单位",width:80,algin:"center"},     
			    {field:"price",title:"价格",width:80,algin:"center"},     
			    {field:"stock",title:"库存",width:80,algin:"center"},     
			    {field:"remark",title:"备注",width:80,algin:"center"},     
			    ]],
		});
		/* 初始化添加dialog */
		$("#dialog").dialog({
...
<body>
	...
	<div id="toolbar">
        ...
        <a href="javascript:doDelete()" class="easyui-linkbutton" iconCls="icon-remove" plain="true" >删除</a>
   		<div>
   			商品名称:<input type="text" id="s_name"/>
   			价格：<input type="text" id="s_price"/>
   			库存：<input type="text" id="s_stock"/>
