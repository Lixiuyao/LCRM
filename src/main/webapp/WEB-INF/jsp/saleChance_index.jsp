...
<title>Insert title here</title>
	<script type="text/javascript">
		...
		function openAddDialog(){
			url = "${ctx}/saleChance/insert.action";
			$("#dialog").dialog("open");
			$("#form").form("clear");
...
<body>
	...
	<div id="toolbar">
		...
		<a href="javascript:openDYBG()" class="easyui-linkbutton" data-options="iconCls:'icon-add'">打印表格</a>
		 <div>
   			客户名字:<input type="text" id="s_customerName"/>
   			联系人：<input type="text" id="s_linkMan"/>
   			创建人:<input type="text" id="s_createMan"/>
   			分配状态:<select id="s_roleName" class="easyui-combobox"
   				editable="false" panelHeight="auto">
   					<option value="">请选择...</option>
   					<option value="已分配">已分配</option>
   					<option value="未分配">未分配</option>
	   			</select><br>
	   		开始时间:<input  id="dd"  type= "text" class= "easyui-datebox" > </input>   
	   		
	   		结束时间:<input  id="dd"  type= "text" class= "easyui-datebox" > </input>   
